...
const features = [
  ...
  },
  {
    ...
    description: 'Watch deployments and scaling happen step by step. Trigger failures, see cascading errors, then replay the success path. Learn by seeing, not reading.',
    icon: (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    description: 'Describe your workload, industry, and constraints. Our assistant recommends the right approach with specific warnings about what can go wrong.',
    icon: (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.5">
